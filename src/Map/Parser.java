...
/**
 * The Parser class is responsible for parsing a .tmx map file and extracting information such as dimensions,
...
public class Parser {
    ...
    /**
     * Constructs a Parser object by parsing a .tmx map file.
     *
     * @param mapPath Path to the .tmx map file.
     */
    public Parser(String mapPath) {
        try {
            ...
            if (mapNodes.getLength() > 0) {
                ...
                System.err.println("Error: Parser file does not contain a valid <map> element.");
            }
        } catch (Exception e) {
