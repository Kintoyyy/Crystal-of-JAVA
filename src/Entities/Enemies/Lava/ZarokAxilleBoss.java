...
public class ZarokAxilleBoss extends Enemy {
    // Low health, high dodge rate, may steal mana.
    public ZarokAxilleBoss(String key) {
        super(new Health(500), new AttackPower(50), new Defense(0));
        this.key = key;
        name = "ZarokAxilleBoss";
        description = "A generic selectedEnemy";
        dodge = 0.2; // 20% chance to dodge attacks

        Frames sheet = new Frames(ImageUtils.loadImage("/Maps/Lava/ZarokAxille_Boss.png"), 64, 64);
