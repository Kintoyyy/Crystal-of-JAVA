...
public class IceOrcChief extends Enemy {
    // Low health, high dodge rate, may steal mana.
    public IceOrcChief(String key) {
        ...
        Frames sheet = new Frames(ImageUtils.loadImage("/Maps/Ice/IceOrc_Chief.png"), 32, 32);
        ...
        animation = new Animation(sheet)
                ...
                .addAnimation(TYPE.DEAD, sheet.extractFrame(3, 13));
    }
}
