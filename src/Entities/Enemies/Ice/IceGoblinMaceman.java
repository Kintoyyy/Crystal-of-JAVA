...
public class IceGoblinMaceman extends Enemy {
    // Low health, high dodge rate, may steal mana.
    public IceGoblinMaceman(String key) {
        super(new Health(500), new AttackPower(50), new Defense(0));
        this.key = key;
        name = "IceGoblinMaceman";
        description = "A generic selectedEnemy";
        dodge = 0.2; // 20% chance to dodge attacks

        Frames sheet = new Frames(ImageUtils.loadImage("/Maps/Ice/IceGoblin_Maceman.png"), 32, 32);
